#configuration script to configure various values for face recognition security system
#adjust the following values as per requirement.
...
HAAR_FACES         = '//home/pi/opencv-3.1.0/data/haarcascades/haarcascade_frontalface_default.xml'
